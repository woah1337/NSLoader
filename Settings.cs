...
namespace NSLoader
{
    class Settings
    {
        ...
        public static string useragent = "2XYpsKltVv"; // make up a random useragent like 2XYpsKltVv for leak protection, and add it to your .htaccess
        ...
        public static string firstdll = "https://yoursite.com/path/yourdll.dll"; // put the name of your first item's dll here
