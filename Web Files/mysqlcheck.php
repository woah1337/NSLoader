//use this if you don't want to use forum software
//people can't register with this, maybe il add register sometime xd
//pasted from mybbcheck.php cause idk php :/
<?php
$link = mysqli_connect("hostname", "root","password");
$database = mysqli_select_db($link, "dbname");

$user = $_GET['username'];
$password = $_GET['password'];
$hwid = mysqli_real_escape_string($link, $_GET['hwid']);
$tables = "yourtablehere";
